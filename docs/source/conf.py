...
latex_documents = [
    (master_doc, "PySyncObj.tex", "PySyncObj Documentation", "Filipp Ozinov", "manual"),
]
...
man_pages = [(master_doc, "pysyncobj", "PySyncObj Documentation", [author], 1)]
